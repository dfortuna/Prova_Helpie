...
class ContactDetailViewController: UIViewController {
    ...
    fileprivate func setCancelLeftButton() {
        let addContactButton = UIBarButtonItem(title: "Cancel", style: .plain, target: self, action: #selector(dismissViewController))
        self.navigationItem.leftBarButtonItem = addContactButton
    }
    ...
    fileprivate func setDoneRightButton() {
        let addContactButton = UIBarButtonItem(title: "Done", style: .done, target: self, action: #selector(updateDataBaseViewController))
